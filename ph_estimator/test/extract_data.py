...
required_columns = ['chl_a_mg_L', 'water_temp_celcius', 'doxy_mg_L', 'pH']
...
print(f"\nKeeping only required columns: {required_columns}")
...
output_path = os.path.join(output_dir, 'water_quality_data_for_pH.csv')
